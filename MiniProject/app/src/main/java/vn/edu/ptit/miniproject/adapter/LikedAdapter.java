...
/**
 * Created by QuangPC on 7/25/2017.
 */

public class LikedAdapter extends ArrayAdapter<ItemSaved> {

    private ArrayList<ItemSaved> arrLike;
    private LayoutInflater inflater;
    public LikedAdapter(@NonNull Context context, @NonNull ArrayList<ItemSaved> objects) {
    ...
    public View getView(int position, @Nullable View v, @NonNull ViewGroup parent) {
        ...
        final  ItemSaved item = arrLike.get(position);
